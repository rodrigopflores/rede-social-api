...
/**
 * UserRepository interface. This interface extends JpaRepository and provides methods for
 * performing CRUD operations on User objects. JpaRepository is a JPA specific extension of
...
public interface UserRepository extends JpaRepository<User, Integer> {
  ...
  /**
   * Custom query method to find users by friend's id and order them by first name in ascending
   * order.
   *
  ...
  /**
   * Custom query method to search users by a search term and exclude a specific user id. The search
   * term is used to match against the first name, last name, email, and nickname fields of the User
   * entity. The search is case-insensitive.
   *
